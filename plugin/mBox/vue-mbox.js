...
!(function (window, undefined) {
    ...
    mBox.install = function (Vue, vueConfig) {
        ...
        VuePro.$mBox.toast = function (options) {
            ...
            switch (mConf.type) {
                case "none":
                    conHtml = "<div class='jemtc'>" + mConf.content + "</div>";
                    break;
                case "success":
                    conHtml = "<div class='success'></div><div class='jemtc'>" + mConf.content + "</div>";
                    break;
                case "error":
                    conHtml = "<div class='error'></div><div class='jemtc'>" + mConf.content + "</div>";
                    break;
                case "loading":
                    conHtml = "<div class='loading'><span></span></div><div class='jemtc'>" + mConf.content + "</div>";
                    break;
            }
            VuePro.$mBox({
                width: mConf.width,
                padding: mConf.padding,
                mask: false,
                time: mConf.time,
                content: conHtml,
                conStyle: Object.assign(asscon, mConf.conStyle),
                closeBtn: mConf.closeBtn,
                success: mConf.success
            })
        };
        //警告提示
        ...
        VuePro.$mBox.notice = function (options) {
            ...
            VuePro.$mBox({
                ...
                time: mConf.time,
                radius: "0px",
                content: "<div class='jemtc'>" + mConf.content + "</div>",
                mask: false,
                conStyle: Object.assign(asscon, mConf.conStyle)
            });
        };
        ...
        VuePro.$mBox.actionSheet = function (options) {
            ...
            VuePro.$mBox({
                ...
                skin: mConf.skins,
                radius: "",
                content: mConf.content,
                conStyle: Object.assign(bgColor, mConf.conStyle),
                success: mConf.success,
                yesCall: mConf.yesCall,
                noCall: mConf.noCall
            });
        };
